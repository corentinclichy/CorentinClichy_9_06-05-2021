...
describe("Given I am connected as Admin and I am on Dashboard page and I clicked on a bill", () => {
  describe("When I see all the bill information", () => {
    test("Then, i should see the name of the file", () => {
      Object.defineProperty(window, "localStorage", {
        value: localStorageMock,
      });
      window.localStorage.setItem(
      ...
      const fileName = screen.getByTestId("fileNameAdmin");

      const fileNameInnerText = fileName.innerHTML;

      expect(fileNameInnerText).toEqual(bills[0].fileName);
    });
  });
